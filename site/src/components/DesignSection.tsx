...
export const DesignSection: React.FC<DesignSectionProps> = ({ lang = "FR" }) => {
  ...
  const cmsDesign = pages[currentPageId]?.sections?.design || {};
  ...
  const heading1 = cmsDesign.title || (lang === "FR" ? "Conçu comme une pièce d'orfèvrerie." : "Engineered as an object.");
  ...
  const cabinetDimVal = cmsDesign.cabinetDim || "600 × 337.5 × 29.7 mm";
  ...
  const subImage = cmsDesign.image || "/uploads/products/wp/module-3.jpg";

  return (
    <EditableWrapper sectionKey="design" sectionLabel="Conception & Dimensions Châssis">
      <section
        id="design"
