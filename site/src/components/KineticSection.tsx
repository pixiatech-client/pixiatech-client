...
export const KineticSection: React.FC<KineticSectionProps> = ({
  lang = "FR",
}) => {
  ...
  // Exact 3D kinetic canvas algorithm from xeron.co module 65561
  useEffect(() => {
    ...
    const render = (timeSec: number) => {
      ...
      for (let r = 0; r < rows; r++) {
        for (let c = cols - 1; c >= 0; c--) {
          ...
          // Physics wave calculation
          let elevation = 14 + 13 * Math.sin(Math.hypot(posX + cellSize / 2 - centerX, posY + cellSize / 2 - centerY) / 64 - 1.1 * timeSec);
          ...
          // Left bevel extrusion (3D shadow)
          ...
          // Bottom bevel extrusion (3D shadow)
          ...
          // Crosshair pattern on front face
          ...
          // Top highlight accent on elevated blocks (PIXIATECH neon green)
          if (uNorm > 0.55) {
  ...
  return (
    ...
    >
      <div className="wrap" style={{ maxWidth: 1520, margin: "0 auto", padding: "0 clamp(16px, 3.5vw, 64px)" }}>
        {/* Eyebrow */}
        <div
          style={{
            fontSize: 11,
        ...
        {/* Split Grid: Canvas on left, CAD Blueprint on right */}
        <div
          className="g2"
          style={{
            display: "grid",
        ...
        >
          ...
          {/* Right: Architectural CAD Blueprint & Exploded Assembly */}
          <div>
            <svg
              viewBox="0 0 560 400"
            ...
            >
              ...
              {/* Z-Axis Travel side view measurement */}
        ...
        {/* Bottom Kinetic Specs Stats Bar */}
        <div
          className="kin-stats"
          style={{
            display: "grid",
