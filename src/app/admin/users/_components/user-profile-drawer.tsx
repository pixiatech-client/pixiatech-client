          ...
          >
            ...
            >
              ...
              <div className="h-full w-full flex flex-col shrink-0 relative overflow-hidden">
                ...
                <div className="px-6 -mt-12 relative flex-1 flex flex-col overflow-y-auto custom-scrollbar">
                  ...
                  <div className="mt-8 space-y-6 flex-1">
                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                      ...
                      <h3 className="text-sm font-bold uppercase tracking-widest text-gray-900">Informations</h3>
                    </div>
              ...
              {/* PAGE 2 */}
              <div className="h-full w-full flex flex-col shrink-0 px-6 py-8 relative overflow-y-auto custom-scrollbar">
                <div className="pb-6 flex justify-center">
                  <div onClick={() => setCurrentPage(0)} className="cursor-pointer">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-6 pt-4">
                      <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                        ...
                        <h3 className="text-sm font-bold uppercase tracking-widest text-gray-900">MOT DE PASSE</h3>
                      </div>
...
const SwipeIcon = ({ direction }: { direction: 'up' | 'down' }) => (
  ...
  >
    {[1, 2, 3].map((i) => (
      ...
      >
        <path d="M2 10L12 2L22 10" stroke="#3b82f6" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ))}
  </motion.div>
);
