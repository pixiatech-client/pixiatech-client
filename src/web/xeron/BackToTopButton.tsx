...
export const BackToTopButton: React.FC<BackToTopButtonProps> = ({ lang = 'FR' }) => {
  ...
  return (
    <button
      ...
      title={ariaLabel}
      className={`fixed bottom-6 right-6 z-40 group w-12 h-12 sm:w-[52px] sm:h-[52px] rounded-full flex items-center justify-center bg-[#0d0d0c]/90 backdrop-blur-md border border-[#2b2b28] text-[#f5f4f0] hover:border-[#C3F910] hover:text-[#C3F910] hover:shadow-[0_0_24px_rgba(195,249,16,0.35)] hover:scale-105 active:scale-95 transition-all duration-300 shadow-2xl cursor-pointer select-none no-underline ${
        isVisible
