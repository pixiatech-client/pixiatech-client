...
export const XERON_PROJECTS: Project[] = [
  { img: '/uploads/projects/how-xeron-elevates-shenzhen-happy-valleys-summer-festival-stage.jpg', title: 'How PixiaTech Elevates Shenzhen Happy Valley&rsquo;s Summer Festival Stage', meta: 'China — 2026', tag: 'RENTAL & EVENTS' },
  { img: '/uploads/projects/university-of-aucklands-hiwa-recreation-and-wellbeing-centre.jpg', title: 'University of Auckland’s Hiwa Recreation and Wellbeing Centre', meta: 'New Zealand — 2026', tag: 'EDUCATION' },
  { img: '/uploads/projects/xeron-powers-up-the-uaes-state-of-the-art-production-studio.jpg', title: 'PixiaTech Powers Up the UAE&rsquo;s State-of-The-Art Production Studio', meta: 'UAE', tag: 'XR / VP' },
  { img: '/uploads/projects/led-wall-evokes-early-cinema-effects-for-poor-things.jpg', title: 'LED Wall Evokes Early-Cinema Effects for Poor Things', meta: 'Hungary — 2024', tag: 'RENTAL & EVENTS' },
];
...
export const XERON_INSIGHTS: Insight[] = [
  { slug: 'stadium-led-screens', img: '/uploads/site/ins-stadium-led-screens.jpg', category: 'GUIDE — FEATURED', chip: 'Guides', tag: 'GUIDE', title: 'Stadium and arena LED screens: scoreboards, perimeter boards and ribbon displays explained', desc: 'Stadium LED screen guide: scoreboards, perimeter boards, ribbon displays and center-hung cubes, with pixel pitch, broadcast, brightness and structure explained.', read: '11 MIN READ', date: '20 SEPT 2026', featured: true },
  { slug: 'led-screen-installation', img: '/uploads/site/ins-led-screen-installation.jpg', category: 'GUIDE', chip: 'Guides', title: 'LED screen installation: seven steps from site survey to commissioning', read: '11 MIN READ', date: '18 SEPT 2026' },
  { slug: 'led-screen-power-consumption', img: '/uploads/site/ins-led-screen-power-consumption.jpg', category: 'LED TECHNOLOGY', chip: 'LED Technology', title: 'How much electricity does an LED screen use? Calculating power draw and cutting it', read: '10 MIN READ', date: '16 SEPT 2026' },
  { slug: 'led-floor-screens', img: '/uploads/site/ins-led-floor-screens.jpg', category: 'GUIDE', chip: 'Guides', title: 'LED floor screens: a guide for dance floors, stages and interactive floors', read: '10 MIN READ', date: '14 SEPT 2026' },
  { slug: 'led-sign-vs-led-screen', img: '/uploads/site/ins-led-sign-vs-led-screen.jpg', category: 'COMPARISON', chip: 'Case Studies', title: 'LED sign or LED screen? The differences and how to choose for your business', read: '10 MIN READ', date: '12 SEPT 2026' },
  { slug: 'led-screen-rental-guide', img: '/uploads/site/ins-led-screen-rental-guide.jpg', category: 'GUIDE', chip: 'Guides', title: 'LED screen rental guide 2026: how to size a wall, choose a pixel pitch and compare quotes', read: '11 MIN READ', date: '10 SEPT 2026' },
  { slug: 'led-screen-prices', img: '/uploads/site/ins-led-screen-prices.jpg', category: 'GUIDE', chip: 'Guides', title: 'What sets the price of an LED display? The 8 factors behind the cost per square metre', read: '12 MIN READ', date: '09 SEPT 2026' },
  { slug: 'led-in-outdoor-advertising', img: '/uploads/site/ins-led-in-outdoor-advertising.jpg', category: 'DOOH', chip: 'DOOH', title: 'Why LED screens now lead outdoor advertising: DOOH versus static billboards', read: '12 MIN READ', date: '08 SEPT 2026' },
  { slug: 'outdoor-led-buying-checklist', img: '/uploads/site/ins-outdoor-led-buying-checklist.jpg', category: 'GUIDE', chip: 'Guides', title: 'Buying an outdoor LED screen: the 10-point checklist before you sign', read: '12 MIN READ', date: '07 SEPT 2026' },
  { slug: 'led-vs-projector', img: '/uploads/site/ins-led-vs-projector.jpg', category: 'COMPARISON', chip: 'Case Studies', title: 'LED wall or projector? Choosing for events, auditoriums and meeting rooms', read: '12 MIN READ', date: '06 SEPT 2026' },
  { slug: 'retail-window-led', img: '/uploads/site/ins-retail-window-led.jpg', category: 'RETAIL', chip: 'Retail', title: 'LED screens for shops and window displays: the digital storefront that sells', read: '11 MIN READ', date: '05 SEPT 2026' },
  { slug: 'event-led-screen-size', img: '/uploads/site/ins-event-led-screen-size.jpg', category: 'GUIDE', chip: 'Guides', title: 'How to size an LED screen for an event: weddings, concerts, trade fairs and launches', read: '11 MIN READ', date: '04 SEPT 2026' },
  { slug: 'led-vs-lcd-video-wall', img: '/uploads/site/ins-led-vs-lcd-video-wall.jpg', category: 'COMPARISON', chip: 'Case Studies', title: 'LED video wall vs LCD video wall: which is right for boardrooms and control rooms', read: '12 MIN READ', date: '03 SEPT 2026' },
  { slug: 'led-screen-lifespan-maintenance', img: '/uploads/site/ins-led-screen-lifespan-maintenance.jpg', category: 'LED TECHNOLOGY', chip: 'LED Technology', title: 'How long does an LED screen last? Lifespan, maintenance schedule and common faults', read: '11 MIN READ', date: '02 SEPT 2026' },
  { slug: 'holographic-displays', img: '/uploads/site/ins-holographic-displays.jpg', category: 'RETAIL', chip: 'Retail', title: 'Holographic fan displays: how 3D hologram fans work and where floating visuals sell', read: '8 MIN READ', date: '01 SEPT 2026' },
  { slug: 'what-is-an-led-screen', img: '/uploads/site/ins-what-is-an-led-screen.jpg', category: 'LED TECHNOLOGY', chip: 'LED Technology', title: 'What is an LED screen and how does it work? From module to controller, every term explained', read: '13 MIN READ', date: '01 SEPT 2026' },
  { slug: 'cob-fine-pitch', img: '/uploads/site/ins-cob-fine-pitch.jpg', category: 'LED TECHNOLOGY', chip: 'LED Technology', title: 'COB vs SMD LED: what changes below 1 mm pixel pitch with chip-on-board and flip-chip LED', read: '8 MIN READ', date: '20 AUG 2026' },
  { slug: 'rental-stage-build', img: '/uploads/site/ins-rental-stage-build.jpg', category: 'GUIDE', chip: 'Guides', title: 'Rental LED screen setup: how a touring LED wall is built, rigged and checked for a show', read: '9 MIN READ', date: '02 AUG 2026' },
  { slug: 'transparent-led', img: '/uploads/site/ins-transparent-led.jpg', category: 'RETAIL', chip: 'Retail', title: 'Transparent LED displays for shop windows and glass façades: mesh, film and glass compared', read: '9 MIN READ', date: '08 JUL 2026' },
  { slug: 'pixel-pitch', img: '/uploads/site/ins-pixel-pitch.jpg', category: 'GUIDE', chip: 'Guides', title: 'LED pixel pitch explained: how to choose the right pitch for viewing distance, cost and power', read: '9 MIN READ', date: '12 JUN 2026' },
  { slug: 'corporate-screens', img: '/uploads/site/ins-corporate-screens.jpg', category: 'CORPORATE AV', chip: 'Corporate AV', title: 'Corporate LED walls: designing lobby, boardroom and briefing-room displays as architecture', read: '8 MIN READ', date: '20 MAY 2026' },
  { slug: 'outdoor-brightness', img: '/uploads/site/ins-outdoor-brightness.jpg', category: 'DOOH', chip: 'DOOH', title: 'Outdoor LED brightness explained: nits, contrast and content for DOOH screens in direct sunlight', read: '8 MIN READ', date: '08 APR 2026' },
  { slug: 'curved-led', img: '/uploads/site/ins-curved-led.jpg', category: 'ARCHITECTURE', chip: 'Architecture', title: 'Curved LED screens: designing concave, convex and wrapped LED walls for architecture', read: '8 MIN READ', date: '14 MAR 2026' },
  { slug: 'xr-stages', img: '/uploads/site/ins-xr-stages.jpg', category: 'VIRTUAL PRODUCTION', chip: 'Virtual Production', title: 'LED volumes for virtual production: how to specify a camera-ready LED wall', read: '9 MIN READ', date: '02 FEB 2026' },
  { slug: 'kinetic', img: '/uploads/site/ins-kinetic.jpg', category: 'LED TECHNOLOGY', chip: 'LED Technology', title: 'Kinetic LED screens explained: how moving LED walls add physical depth to digital content', read: '8 MIN READ', date: '15 JAN 2026' },
];
