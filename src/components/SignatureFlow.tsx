...
- Frais logistique de livraison : ${(250 * quantity).toLocaleString('fr-FR')} € TTC
- Prestation d'Installation : ${isInstallationIncluded ? `Incluse par nos techniciens (${(installationFee * quantity).toLocaleString('fr-FR')} € TTC)` : 'Non incluse - par vos soins (Pixiatech décline toute responsabilité)'}
          ...
          <div className="space-y-8 animate-fade-in" id="estimation-recap-main-card">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-6">
                ...
                {/* Installation - toujours visible, sans accordéon */}
                ...
                <div className="bg-white border border-[#e2e8f0] rounded-[24px] p-9 shadow-sm space-y-5">
                  ...
                  <div className="border-t border-zinc-100 pt-3 space-y-2 text-xs font-semibold">
                    <div className="flex justify-between items-center">
                      <span className="text-zinc-400">Matériel LED</span>
