...
export function canAccessRoute(role: UserRole | undefined, route: string): boolean {
  ...
  if (route.startsWith('/admin/products') || route.startsWith('/admin/history') || route.startsWith('/admin/amine') || route.startsWith('/admin/locations') || route.startsWith('/admin/site-web')) {
