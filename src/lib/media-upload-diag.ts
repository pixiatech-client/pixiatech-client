...
export const UPLOAD_ERROR_CODES = {
  ...
  FFMPEG_INTERRUPTED: 'UPLOAD_FFMPEG_INTERRUPTED',
...
const USER_MESSAGES: Record<UploadErrorCode, string> = {
  ...
  [UPLOAD_ERROR_CODES.FFMPEG_INTERRUPTED]: "Traitement interrompu — veuillez réessayer. La vidéo source est conservée.",
