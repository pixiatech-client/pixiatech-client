...
import { Pack, RenterDetails } from '../types';
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 sm:p-5 mb-8 text-zinc-700">
            ...
            <ul className="space-y-1.5 text-[11px] sm:text-xs">
              ...
              <li className="flex items-start gap-2">
                <span className="text-blue-600 mt-1">•</span>
                <span>
                  Loyer mensuel : <strong className="text-zinc-900">{pack.price}€ TTC/mois</strong> (Sans engagement de durée)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-600 mt-1">•</span>
                <span>
                  Dépôt de garantie requis (Caution) : <strong className="text-zinc-900">{pack.deposit}€ TTC</strong>
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="mt-10 pt-6 border-t border-zinc-150 text-zinc-700 text-[11px] sm:text-xs">
            ...
            <div className="grid grid-cols-2 gap-6 relative font-sans">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                {/* Simulated Stamp and Signed Graphic */}
              ...
              <div className="flex flex-col items-center text-center">
                ...
                {/* Interactive preneur signature spot */}
            ...
            {/* PandaDoc Footer seal to match image step details */}
