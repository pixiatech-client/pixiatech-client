...
export default function SignaturePad({ onSave, onClear, isValidated }: SignaturePadProps) {
  ...
  // For high-DPI displays, configure backing store if necessary,
  // but a simple responsive standard canvas is perfectly portable for signatures.
    ...
    <div className="w-full flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3">
        <button
          ...
          type="button"
          onClick={clearCanvas}
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-medium border border-zinc-200 bg-white hover:bg-zinc-50 rounded-xl transition-all cursor-pointer text-zinc-650 hover:text-zinc-900 active:scale-98 shadow-sm"
        >
          <Eraser size={16} />
